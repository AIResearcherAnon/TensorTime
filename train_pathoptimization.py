...
def train(argv):
    ...
    checkpoint = torch.load(f"./models/{config['net_g']}/model_cifar10_weights_step_400000.pt")
    ...
    # Trainer   
    savedir = FLAGS.output_dir + "/" + config['net_g'] + "/" + "path_optimization"  + "/" + str(config['M']) + "/" + config['spatial_dimension'] + "/"
